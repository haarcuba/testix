...
.. code:: python
   ...
   monitor = line_monitor.monitor.Monitor(['ls', '-l'], on_output=captured_lines.append) # launch `ls -l` to list the files, lines get appended into our captured_lines list
